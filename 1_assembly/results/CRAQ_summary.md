...
![CRAQ genome summary](/1_assembly/pipeline/02-03_denovo_correct/rep_results/craq_genome_summary.png)

Header examples from some of the CRAQ output reports & visualisation
